...
function loadRollerBabies () {
  ...
  myVideo.load()
  var loadRollerBabiesLog = 'Enjoy watching Roller Babies' + '<br>'
...
function loadBabyMe () {
  ...
  myVideo.load()
  var loadBabyMeLog = 'Enjoy watching Baby Me' + '<br>'
...
function loadSurfingBaby () {
  ...
  myVideo.load()
  var loadSurfingBabyLog = 'Enjoy watching Surfing Babies' + '<br>'
